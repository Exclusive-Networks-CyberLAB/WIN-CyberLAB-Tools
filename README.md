...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; iwr https://raw.githubusercontent.com/Exclusive-Networks-CyberLAB/WIN-CyberLAB-Tools/refs/heads/main/CyberLAB-quickstart.ps1 -UseBasicParsing | iex
```
